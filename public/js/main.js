...
socket.on('message', function(message) {
  ...
  if (message === 'got user media') {
    ...
    pc[clientNumber].setRemoteDescription(new RTCSessionDescription(message));
    doAnswer();
    ...
    pc[clientNumber].addIceCandidate(candidate);
...
function createPeerConnection() {
  try {
    pc[clientNumber] = new RTCPeerConnection(null);
...
function doAnswer() {
  ...
  pc[clientNumber].createAnswer().then(
...
function setLocalAndSendMessage(sessionDescription) {
  pc[clientNumber].setLocalDescription(sessionDescription);
